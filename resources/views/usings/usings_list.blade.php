                    ...
                    <tbody>
                        @foreach ($usings as $using)
                            <tr>
                                ...
                                <td>
                                    <!-- Edit Button -->
                                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#editModal{{ $using->id }}">
...
@foreach ($usings as $using)
    ...
    <div class="modal fade" id="deleteModal{{ $using->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $using->id }}" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel{{ $using->id }}">{{ trans('main_trans.delete') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
