                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#editModal{{ $type->id }}" class="btn btn-primary"
                                    data-toggle="modal">{{ trans('main_trans.edit') }}</a>

    <a href="#" class="btn btn-danger" onclick="openDeleteModal('{{ $type->id }}')">{{ trans('main_trans.delete') }}</a>
</td>
                            </td>
                        </tr>
                        @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createUserModalLabel">{{ trans('main_trans.user_name') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('types.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="type">{{ trans('main_trans.user_name') }}</label>
