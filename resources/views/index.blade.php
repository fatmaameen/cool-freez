		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center justify-content-between">
				...
				<div class="banner-img col-lg-4 col-md-6">
					<img class="img-fluid" src="assets/landing_page/img/banner-img.png" alt="">
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-lg-6 home-about-right home-about-right2">
					...
					<h4>
						Through the application, all reviews,
                        whether positive or negative, on the service provided by the program are received.</h4><br>
					<div class="download-button d-flex flex-row justify-content-start">
						<div class="buttons flex-row d-flex">
							<i class="fa fa-apple" aria-hidden="true"></i>
							<div class="desc">
				...
				<div class="col-lg-5 home-about-left">
					<img class="img-fluid" src="assets/landing_page/img/iphone.png" alt="">
				</div>
			</div>
		</div>
	</section>
