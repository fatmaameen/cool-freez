    ...
    <div class="page-title">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <h6><li class="breadcrumb-item active">/{{ trans('main_trans.brands') }}</li></h6>
                </ol>
            </div>
        </div>
    </div>
...
@section('content')
                ...
                <div class="modal-body">
                    <form action="{{ route('brands.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="brand">{{ trans('main_trans.en_name') }}</label>
                            <input type="text" class="form-control" id="brand_en" name="brand_en">
                            <label for="brand">{{ trans('main_trans.ar_name') }}</label>
    ...
    @foreach ($filteredData as $brand)
        <div class="modal fade" id="editModal{{ $brand['id'] }}" id="staticBackdrop" data-backdrop="static" tabindex="-1"
                    ...
                    <div class="modal-body">
                        <form action="{{ route('brands.update', $brand['id']) }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="brand">{{ trans('main_trans.en_name') }}</label>
                                <input type="text" class="form-control" id="brand_en" name="brand_en"
                                    value="{{ $brand['brand_en'] }}">
                                <label for="brand">{{ trans('main_trans.ar_name') }}</label>
                                <input type="text" class="form-control" id="brand_ar" name="brand_ar"
                                    value="{{ $brand['brand_ar'] }}">
                            </div>
        ...
        <div class="modal fade" id="deleteModal{{ $brand['id'] }}" data-bs-backdrop="static" tabindex="-1"
            aria-labelledby="deleteModalLabel{{ $brand['id'] }}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel{{ $brand['id'] }}"></h5>
