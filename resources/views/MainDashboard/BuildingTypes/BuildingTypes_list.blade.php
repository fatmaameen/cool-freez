    ...
    <div class="page-title">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <h6><li class="breadcrumb-item active">/{{ trans('main_trans.buildingTypes') }}</li></h6>
                </ol>
            </div>
        </div>
    </div>
...
@section('content')
                ...
                <div class="card card-statistics h-100">
                    <div class="card-body">
                        ...
                        <table class="table table-bordered  w-100">
                            ...
                            <tbody>
                                @foreach ($filteredData as $buildingtype)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" data-toggle="modal"
                                                data-target="#editModal{{ $buildingtype['id'] }}">
                                                <i class="fas fa-pen-to-square fa-2xl"></i>
                                            </a>

                                            <!-- Delete Button -->
                                            <a href="#" class="btn btn-danger" data-toggle="modal"
                                                data-target="#deleteModal{{ $buildingtype['id'] }}">
                ...
                <div class="modal-body">
                    <form action="{{ route('buildingTypes.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="name">{{ trans('main_trans.en_name') }}</label>
                            <input type="text" class="form-control" id="name_en" name="name_en">
                            <label for="name">{{ trans('main_trans.ar_name') }}</label>
    ...
    @foreach ($filteredData as $buildingtype)
        <!-- Edit Modal -->
        <div class="modal fade" id="editModal{{ $buildingtype['id'] }}" tabindex="-1"
            aria-labelledby="editModalLabel{{ $buildingtype['id'] }}" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel{{ $buildingtype['id'] }}">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('buildingTypes.update', $buildingtype['id']) }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="name">{{ trans('main_trans.en_name') }}</label>
                                <input type="text" class="form-control" id="name_en" name="name_en"
                                    value="{{ $buildingtype['name_en'] }}">
                                <label for="name">{{ trans('main_trans.ar_name') }}</label>
                                <input type="text" class="form-control" id="name_ar" name="name_ar"
                                    value="{{ $buildingtype['name_ar'] }}">
                            </div>
                            <div class="modal-footer">
        ...
        <!-- Delete Modal -->
        <div class="modal fade" id="deleteModal{{ $buildingtype['id'] }}" tabindex="-1"
            aria-labelledby="deleteModalLabel{{ $buildingtype['id'] }}" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
