                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $review->code }}</td>
                            <td>
                                <a href="{{ route('details' ,$review->id) }}" class="btn btn-primary" >{{ trans('main_trans.show') }}</a>
                            </td>
                            ...
                            <td>
                            <a href="#editModal{{ $review->id }}" class="btn btn-primary"
                                data-toggle="modal">{{ trans('main_trans.edit_status') }}</a>


                       <a href="#" class="btn btn-danger"
                       onclick="openDeleteModal('{{ $review->id }}')">{{ trans('main_trans.delete') }}</a>
<td>
...
<div class="modal fade" id="consModal{{ $review->id }}" tabindex="-1" role="dialog" aria-labelledby="consModalLabel{{ $review->id }}" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <!-- Modal content goes here -->
            <div class="modal-header">
                <h5 class="modal-title" id="consModalLabel{{ $review->id }}">{{ trans('main_trans.consultant_data') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img class="rounded-circle"
                            src="{{'http://127.0.0.1:8000/consultants/'. $review->consultant->image}}"
                            width="60"
                            height="60"
                          ></td>
...
<!-- Edit User Modals -->
<div class="modal fade" id="editModal{{ $review->id }}" id="staticBackdrop" data-backdrop="static" tabindex="-1" aria-labelledby="editModalLabel{{ $review->id }}"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel{{ $review->id }}">{{ trans('main_trans.edit') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
