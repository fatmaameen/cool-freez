			...
			<div class="row banner-content">
				<div class="col-lg-12 d-flex align-items-center justify-content-between">
					<div class="left-part">
						...
						<p>
							This program provides an air conditioning maintenance service. The user first logs into the program and enters the air conditioning data and submits the data. The program will calculate the cost of this service and send it to you. Upon clicking confirm, those in charge of the program will send the technician to you to provide you with the best service.
						</p>
					</div>
